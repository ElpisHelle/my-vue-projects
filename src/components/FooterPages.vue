            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="title pl-3">About us</div>
                        <div class="content">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="title pl-3">Quick Link</div>
                        <div class="content">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="content">
                            <div class="title pl-3"> News Letter</div>
                            ...
                            <div class="check d-flex align-items-start">
                                <input type="checkbox" name="accept" id="accept">
                                <label for="accept">Subscribing I accept the privacy rules of this site</label>
                            </div>
                            <div class="subscribe">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="content">
                            <div class="title pl-3">Social Links</div>
