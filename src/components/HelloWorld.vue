    ...
    <div class="section_1">
            ...
            <div class="nav_bar d-flex flex-column">
              ...
              <div class="d-flex mt-2 justify-content-end">
                <input
                    ...
                    class="search"
                    name="search"
                    style="border-radius: 4px; border:1px solid #E9E9E9"
                  />
                  <button  class="btn-fa serarch_button">
                    <svg
      ...
      <div class="d-flex topbar justify-content-center mt-2">
            <ul class="d-flex ul_list ">
              ...
              <li class="list_item">FOREIGN LANGUAGE<br /><span class="d-flex justify-start">SUPPORT</span></li>
              <li class="list_item">MARKET RESEARCH<br /><span class="d-flex justify-start">& ANALYSIS</span> </li>
              <li class="list_item">TRANSCRIPTION<br/><span class="d-flex justify-start">SERVICES</span> </li>
              <li class="list_item">MULTLINGUAL<br/><span class="d-flex justify-start">CALL CENTER</span> </li>
              <li class="list_item">DATA ENTRY<br/><span class="d-flex justify-start">SERVICES</span> </li>
